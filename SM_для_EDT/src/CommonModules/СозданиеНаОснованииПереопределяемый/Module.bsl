...
Процедура ПриОпределенииОбъектовСКомандамиСозданияНаОсновании(Объекты) Экспорт
	...
	// ++ rarus atyutyakin 02.02.2021  [ФТ.ИМ.02.01]
	Объекты.Добавить(Метаданные.Документы.впПриходТМЦ);
	Объекты.Добавить(Метаданные.Документы.рарусРасходТМЦ);
	Объекты.Добавить(Метаданные.Документы.рарусИзменениеСтатусаТМЦ);
	// -- rarus atyutyakin 02.02.2021
	
	// ++ rarus atyutyakin 18.02.2021  [ФТ.ИМ.02.01]
	Объекты.Добавить(Метаданные.Документы.впЗаявкаНаСнабжение);
	// -- rarus atyutyakin 18.02.2021
