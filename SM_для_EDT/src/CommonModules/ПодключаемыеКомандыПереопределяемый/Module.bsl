...
Процедура ПриОпределенииВидовПодключаемыхКоманд(ВидыПодключаемыхКоманд) Экспорт
	...
	// Сделал 2 вида команд для того, чтобы команда с флагом и без флага не объединялись
	// и не появлялось общее подменю
	Вид = ВидыПодключаемыхКоманд.Добавить();
	Вид.Имя         = "ОбменССудном1";
	Вид.ИмяПодменю  = "ПодменюБСО1";
	Вид.Заголовок   = НСтр("ru = 'Обмен с судном'");
	Вид.Картинка    = БиблиотекаКартинок.рарусСудно;
	Вид.Отображение = ОтображениеКнопки.КартинкаИТекст;
	
	Вид = ВидыПодключаемыхКоманд.Добавить();
	Вид.Имя         = "ОбменССудном2";
	Вид.ИмяПодменю  = "ПодменюБСО2";
	Вид.Заголовок   = НСтр("ru = 'Обмен с судном'");
	Вид.Картинка    = БиблиотекаКартинок.рарусСудно;
	Вид.Отображение = ОтображениеКнопки.КартинкаИТекст;
	...
	Вид = ВидыПодключаемыхКоманд.Добавить();
	Вид.Имя         = "ОтправкаНаБерег";
	Вид.ИмяПодменю  = "ПодменюОтправкаНаБерег";
	Вид.Заголовок   = НСтр("ru = 'Регистрация к отправке в береговую систему'");
	Вид.Картинка    = БиблиотекаКартинок.ЗарегистрироватьИОтправить;
	Вид.Отображение = ОтображениеКнопки.Картинка;
	// -- rarus makole 2021-03-30
	
	// ++ rarus PleA 18.05.2021 [РАIT-0023342]
	Вид = ВидыПодключаемыхКоманд.Добавить();
	Вид.Имя         = "ПоказатьИсходныеДанные";
	Вид.ИмяПодменю  = "";
	Вид.Заголовок   = НСтр("ru = 'Показать исходные данные'");
	// -- rarus PleA
...
Процедура ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды) Экспорт
	...
	// ++ rarus makole 2020-10-28 [СТТ БСО.СМ.006]
	// Хранение признака критичности данных
	ПодключатьКомандуКритичности = рарусСинхронизацияССудном.ПодключатьКомандуКритичности(Источники.Строки[0].Метаданные);
	Если ПодключатьКомандуКритичности Тогда
		
		рарусСинхронизацияССудном.ДобавитьКомандуВключенияКритичностиДанных(Команды);
		
	КонецЕсли;
	// -- rarus makole 2020-10-28 [СТТ БСО.СМ.006]
	
	// ++ rarus makole 2021-10-07
	// Код вынесен в модуль менеджера регистра
	РегистрыСведений.рарусСостоянияОтправкиОбъектов.ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды);
	// -- rarus makole 2021-10-07
	
	// ++ rarus PleA 22.06.2021 [РАIT-0023342]
	рарусХранениеВерсий.ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды);
	// -- rarus PleA
