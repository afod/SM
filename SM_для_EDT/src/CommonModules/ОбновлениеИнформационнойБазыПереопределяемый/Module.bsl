...
Процедура ПриПодготовкеМакетаОписанияОбновлений(Знач Макет) Экспорт
	...
	ТекстОписания = Обработки.рарусИнформацияОбОбновлении.ПолучитьМакет("МакетИнформацияОбновления").ПолучитьТекст();
	ТекстОписания = СтрЗаменить(ТекстОписания, "#Область ОписаниеОбновлений", "");
	ТекстОписания = СтрЗаменить(ТекстОписания, "#КонецОбласти", "");
	Макет.Область("R3C1:R3C1").Текст = ТекстОписания;
