...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	// ++ rarus PleA 21.01.2021 [26717 ]
	СписокОбъектов.Добавить(Документы.впЗаявкаНаСнабжение);	
	// -- rarus PleA
	
	// ++ rarus ilshill 12.02.2021 	
	Если ПолучитьФункциональнуюОпцию("рарусИспользоватьФункционалСУБ") Тогда		
		СписокОбъектов.Добавить(Справочники.vftДокладыОНесоответствии);
		// ++ rarus zalikh 2021-05-08 [27315]
		СписокОбъектов.Добавить(Документы.рарусМероприятиеСУБ);
		// -- rarus zalikh 2021-05-08 [27315]
	КонецЕсли;
	// ++ rarus ilshill 12.02.2021
	
	// ++ rarus yukuzi 07.02.2021   // ФТ.СНБ.02. Задача_Штрихкодирование
		СписокОбъектов.Добавить(Документы.впПриходТМЦ);	
		// -- rarus yukuzi 07.02.2021
