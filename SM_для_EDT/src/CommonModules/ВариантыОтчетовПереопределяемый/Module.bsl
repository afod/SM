...
Процедура ОпределитьРазделыСВариантамиОтчетов(Разделы) Экспорт
	...
	// ++ rarus ilshill 29.01.2021
	//Если ПолучитьФункциональнуюОпцию("рарусИспользоватьФункционалСУБ") Тогда
		
		Разделы.Добавить(Метаданные.Подсистемы.VftЭлектронныеСообщения,
		НСтр("ru = 'Отчеты по СУБ';
		|en = 'Security management system reports'") );
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	//   // ++ rarus ilshill 29.01.2021	
	ОписаниеОтчета = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.рарусДокументыСудна);
	ОписаниеОтчета.Размещение.Вставить(Метаданные.Подсистемы.VftЭлектронныеСообщения);
	ОписаниеОтчета.ОпределитьНастройкиФормы = Истина;	
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "ОсновнойВариантОтчета");
	ОписаниеВарианта.Описание = НСтр("ru='Сколько документов по судну?'");
	
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "КонтекстныйВариантОтчета");	
	ОписаниеВарианта.Включен = Ложь;
	
	ОписаниеОтчета = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.vftNearMissReport);
	ОписаниеОтчета.Размещение.Вставить(Метаданные.Подсистемы.VftЭлектронныеСообщения);
	ОписаниеОтчета.ОпределитьНастройкиФормы = Истина;	
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "NearMissReport");
	ОписаниеВарианта.Описание = НСтр("ru='Сколько сообщений по судну?'");
	
	ОписаниеОтчета = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.vftДокладыОСостоянииБезопасности);
	ОписаниеОтчета.Размещение.Вставить(Метаданные.Подсистемы.VftЭлектронныеСообщения);
	ОписаниеОтчета.ОпределитьНастройкиФормы = Истина;	
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "NearMissReport");
	ОписаниеВарианта.Описание = НСтр("ru='Сколько создано докладов о состоянии безопасности?'");
	
	ОписаниеОтчета = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.рарусОтчетПоЗамечаниям);
	ОписаниеОтчета.Размещение.Вставить(Метаданные.Подсистемы.VftЭлектронныеСообщения);
	ОписаниеОтчета.ОпределитьНастройкиФормы = Истина;	
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "СводныйВариант");
	ОписаниеВарианта.Описание = НСтр("ru='Количество замечаний?'");
	
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "СводныйВариантКонтекст");	
	ОписаниеВарианта.Включен = Ложь;
	
	ОписаниеОтчета = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.рарусОтчетПоПроведеннымМероприятиямСУБ);
	ОписаниеОтчета.Размещение.Вставить(Метаданные.Подсистемы.VftЭлектронныеСообщения);
	ОписаниеОтчета.ОпределитьНастройкиФормы = Истина;	
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "ОсновнойВариантОтчета");
	ОписаниеВарианта.Описание = НСтр("ru='Количество проведенных мероприятий за период?'");
	
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "КонтекстныйВариантОтчета");	
	ОписаниеВарианта.Включен = Ложь;

	ОписаниеОтчета = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.рарусГрафикМероприятийСУБ);
	ОписаниеОтчета.Размещение.Вставить(Метаданные.Подсистемы.VftЭлектронныеСообщения);
	ОписаниеОтчета.ОпределитьНастройкиФормы = Истина;	
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "ОсновнойВариантОтчета");
	ОписаниеВарианта.Описание = НСтр("ru='Количество запланированных и проведенных мероприйтий СУБ и аудитов?'");
	
	ОписаниеОтчета = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.vftКонтрольЗаНесоответствиямиНаСудах);
	ОписаниеОтчета.Размещение.Вставить(Метаданные.Подсистемы.VftЭлектронныеСообщения);
	ОписаниеОтчета.ОпределитьНастройкиФормы = Истина;	
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "Основной");
	ОписаниеВарианта.Описание = НСтр("ru='Количество докладов о несоответствии?'");

	ОписаниеОтчета = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.vftСводныйЛистУчетаНесоответствий);
	ОписаниеОтчета.Размещение.Вставить(Метаданные.Подсистемы.VftЭлектронныеСообщения);
	ОписаниеОтчета.ОпределитьНастройкиФормы = Истина;	
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "Основной");
	ОписаниеВарианта.Описание = НСтр("ru=''");

	//// -- rarus ilshill 29.01.2021
	
	// ++ rarus zalikh 2021-05-20 [27019]
	ОписаниеОтчета = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.рарусОтчетПоСудовымСвидетельствам);
	ОписаниеОтчета.Размещение.Вставить(Метаданные.Подсистемы.VftЭлектронныеСообщения);
	ОписаниеОтчета.ОпределитьНастройкиФормы = Истина;	
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "ОсновнойВариантОтчета");
	ОписаниеВарианта.Описание = НСтр("ru='Отчет по судовым свидетельствам'");		
	// -- rarus zalikh 2021-05-20 [27019]
...
Процедура ОпределитьОбъектыСКомандамиОтчетов(Объекты) Экспорт
	...
	Объекты.Добавить(Метаданные.Документы.впАктОВыполненииЭтапаРабот);
	Объекты.Добавить(Метаданные.Документы.впЗаявкаНаРемонт);
	// rarus evgenu 2020_12_09 --
	// rarus evgenu 2020_12_17 ++ 
	Объекты.Добавить(Метаданные.Документы.впВыявленныеДефекты);
	// rarus evgenu 2020_12_17 --
	// rarus evgenu 2020_12_18 ++ 
	Объекты.Добавить(Метаданные.Документы.впСостоянияОбъектовРемонта);
	// rarus evgenu 2020_12_18 --
	
	// ++ rarus PleA 18.12.2020 [26055]
	Объекты.Добавить(Метаданные.Документы.рарусАктВыполненныхРаботОказанныхУслуг);
	// -- rarus PleA
	
	// ++ rarus ilshill 01.02.2021
	Объекты.Добавить(Метаданные.Справочники.рарусСвидетельстваСудов);
	Объекты.Добавить(Метаданные.Документы.рарусМероприятиеСУБ);
	// -- rarus ilshil 01.02.2021
...
Процедура ПередДобавлениемКомандОтчетов(КомандыОтчетов, Параметры, СтандартнаяОбработка) Экспорт
	...
	// ++ rarus makole 2021-01-27 
	ДокументыСОтчетомОДвижениях = Новый Массив;
	ДокументыСОтчетомОДвижениях.Добавить(Метаданные.Документы.рарусИнвентаризацияТМЦ);
	ДокументыСОтчетомОДвижениях.Добавить(Метаданные.Документы.рарусИзменениеСтатусаТМЦ);
	ДокументыСОтчетомОДвижениях.Добавить(Метаданные.Документы.рарусРасходТМЦ);
	ДокументыСОтчетомОДвижениях.Добавить(Метаданные.Документы.впПриходТМЦ);
	// ++ rarus makole 2021-02-25
	ДокументыСОтчетомОДвижениях.Добавить(Метаданные.Документы.рарусЗаказКлиента);
	ДокументыСОтчетомОДвижениях.Добавить(Метаданные.Документы.рарусЗаказНаПеремещение);
	// -- rarus makole 2021-02-25
	// ++ rarus makole 2021-04-09 [Задача № 28517]
	ДокументыСОтчетомОДвижениях.Добавить(Метаданные.Документы.впЗаказПоставщику);
	// -- rarus makole 2021-04-09 [Задача № 28517]
