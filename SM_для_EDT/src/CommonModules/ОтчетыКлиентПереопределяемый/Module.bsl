...
Процедура ОбработкаРасшифровки(ФормаОтчета, Элемент, Расшифровка, СтандартнаяОбработка) Экспорт
	...
	Если ПолноеИмяОтчета = "Отчет.рарусАнализТехническогоОбслуживания" Тогда
		
		//ПоляРасшифровки = Новый Массив;
		//
		//ПоляРасшифровки.Добавить("Судно");
		//ПоляРасшифровки.Добавить("ПоказательЗаголовок");
		//ПоляРасшифровки.Добавить("Значение");
		//
		...
		//	ПоляРасшифровки);
		//
		//Если ДанныеРасшифровкиОтчета.Свойство("Значение") Тогда 
			
			СтандартнаяОбработка  = Ложь;
			
			ФормаОтчета.Отчет.КомпоновщикНастроек.ФиксированныеНастройки.Структура.Очистить();
			ПереопределяемыеНастройки = ФормаОтчета.Отчет.КомпоновщикНастроек.ФиксированныеНастройки;
			НовГруппировка = ПереопределяемыеНастройки.Структура.Добавить(Тип("ГруппировкаКомпоновкиДанных"));
			НовГруппировка.Имя = "Расшифровка";
			НовГруппировка.Использование=Истина;
			НовПолеГруппировки = НовГруппировка.ПоляГруппировки.Элементы.Добавить(Тип("ПолеГруппировкиКомпоновкиДанных"));
			НовПолеГруппировки.Использование = Истина;
			НовПолеГруппировки.Поле = Новый ПолеКомпоновкиДанных("РасширеннаяРасшифровка");
			НовГруппировка.Состояние = СостояниеЭлементаНастройкиКомпоновкиДанных.Включен;
			
			
			Парам = Новый Структура;
			Парам.Вставить("СформироватьПриОткрытии", Истина);
			Парам.Вставить("Расшифровка", Новый ОписаниеОбработкиРасшифровкиКомпоновкиДанных(ФормаОтчета.ОтчетДанныеРасшифровки, Расшифровка, ПереопределяемыеНастройки));
			ОткрытьФорму("Отчет.рарусАнализТехническогоОбслуживания.Форма", Парам, , Истина);
