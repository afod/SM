...
Процедура ЗаполнитьСписокВыбора(СписокВыбора, ПараметрыВыбора) Экспорт
	...
	Для Каждого ЭлементВыбора Из Справочники.УдалитьУпаковкиНоменклатуры.ПолучитьДанныеВыбора(ПараметрыВыбора) Цикл
...
Процедура ОбработкаПолученияДанныхВыбора(ДанныеВыбора, Параметры, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ВыборРодителя") Тогда
		...
		Запрос.Текст =
		"ВЫБРАТЬ
		|	УдалитьУпаковкиНоменклатуры.Ссылка КАК Упаковка,
		|	ПРЕДСТАВЛЕНИЕ(УпаковкиНоменклатуры.Ссылка) КАК УпаковкаПредставление
		|ИЗ
		|	Справочник.УдалитьУпаковкиНоменклатуры КАК УпаковкиНоменклатуры
		|ГДЕ
...
Процедура ПолучитьСписокДляВыбораУпаковок(Номенклатура, ДанныеВыбора, СтрокаПоиска, Знач ДобавлятьПустуюУпаковку)
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.УдалитьУпаковкиНоменклатуры КАК СпрУпаковки
	...
	Если ДобавлятьПустуюУпаковку
		...
		ДанныеВыбора.Вставить(0,Справочники.УдалитьУпаковкиНоменклатуры.ПустаяСсылка(), ЕдиницаХраненияПредставление)
	КонецЕсли;
