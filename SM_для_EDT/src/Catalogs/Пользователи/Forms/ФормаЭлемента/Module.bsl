...
// с сохранением истории изменения этой привязки (период - день)
&НаКлиенте
Процедура ИсторияФизическихЛиц(Команда)
	ОткрытьФорму("РегистрСведений.рарусСоответствиеПользователяФизическомуЛицу.ФормаСписка", Новый Структура("Пользователь", Объект.Ссылка));
КонецПроцедуры
// -- rarus makole 2020-12-15 [Задача № 25921]
