...
Процедура ОбработкаПолученияФормы(ВидФормы, Параметры, ВыбраннаяФорма, ДополнительнаяИнформация, СтандартнаяОбработка)
	...
	РаботаСФайлами.ОпределитьФормуПрисоединенногоФайла(
			Справочники.впВыявленныеДефектыПрисоединенныеФайлы, 
...
//
// Параметры:
//  СсылкаНаОбъект  - СправочникСсылка.впВыявленныеДефектыПрисоединенныеФайлы - ссылка на объект, связанные объекты которого требуется вернуть
//
// Возвращаемое значение:
