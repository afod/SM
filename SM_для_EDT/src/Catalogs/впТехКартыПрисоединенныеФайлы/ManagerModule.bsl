...
Процедура ОбработкаПолученияФормы(ВидФормы, Параметры, ВыбраннаяФорма, ДополнительнаяИнформация, СтандартнаяОбработка)
	...
	РаботаСФайламиКлиентСервер.ОпределитьФормуПрисоединенногоФайла(
			Справочники.впТехКартыПрисоединенныеФайлы, 
...
//
// Параметры:
//  СсылкаНаОбъект  - СправочникСсылка.впТехКартыПрисоединенныеФайлы - ссылка на объект, связанные объекты которого требуется вернуть
//
// Возвращаемое значение:
