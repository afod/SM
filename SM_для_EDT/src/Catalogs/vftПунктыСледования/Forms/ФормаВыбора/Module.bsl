...
Процедура ПриОткрытии(Отказ)
	...
	// ++ rarus Камаев П.В. 17.08.2020 Задача 23173 
...
Процедура СброситьВсеОтборы()
	...
	Для Каждого Элемент из Список.Отбор.Элементы Цикл
		...
		Если Элемент.Представление = "ОтборПоНаименованию" Тогда
...
Процедура СтрокаПоискаПриИзменении(Элемент)
	...
	Если ПереключательПоиска = 0 Тогда
		...
		//----------------------
		// ++ rarus Камаев П.В. 25.01.2021 Задача № 26829
		//Был отбор только по Наименованию, добавил НаименованиеНаАнглийском 
		Группа = Список.Отбор.Элементы.Добавить(Тип("ГруппаЭлементовОтбораКомпоновкиДанных"));
		Группа.Представление = "ОтборПоНаименованию";
		...
		ЭлементОтбора = Группа.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
		ЭлементОтбора.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("НаименованиеНаАнглийском");
		ЭлементОтбора.ВидСравнения = ВидСравненияКомпоновкиДанных.Содержит;
		ЭлементОтбора.Использование = Истина;
		ЭлементОтбора.РежимОтображения = РежимОтображенияЭлементаНастройкиКомпоновкиДанных.Недоступный;
		ЭлементОтбора.ПравоеЗначение = СокрЛП(СтрокаПоиска);
