...
Процедура ЗаполнитьТаблицуЗначенийНаСервере(ПараметрОтбора)
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |	ДанныеПланГрафиков.ВидМероприятия.ВидМероприятия КАК ВнешнееВнутреннее,
	               |	ДанныеПланГрафиков.ВидМероприятия.КонтролирующийОрган КАК КонтролирующийОрган,
	               |	ДанныеПланГрафиков.ВидМероприятия.ТипМероприятия КАК ТипМероприятия
	               |ИЗ
	               ...
	               |	И ДанныеПланГрафиков.Статус <> ЗНАЧЕНИЕ(Перечисление.vftСтатусыДокументовСообщений.Черновик)
	               |	И ДанныеПланГрафиков.ВидМероприятия.ТипМероприятия <> ЗНАЧЕНИЕ(Перечисление.рарусТипыМероприятия.Учение)";
